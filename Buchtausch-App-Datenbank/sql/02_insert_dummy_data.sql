...
-- DATEI: 02_insert_dummy_data.sql
-- AUTOR: Firas Alshamam
-- MATRIKELNUMMER: UPS10769810
-- BESCHREIBUNG: Dummy-Daten (mind. 10 Einträge pro Tabelle)
-- =====================================================
...
('Ferdinand', 'von Schirach', '1964-01-01', 'Deutsch', 'Deutscher Strafverteidiger und Schriftsteller'),
...
('9783462048533', 'Die Liebe in den Zeiten der Cholera', 4, 1985, 'Deutsch', 416, 'Klassiker von García Márquez'),
('9783596703009', 'Der Heimweg', 6, 2020, 'Deutsch', 450, 'Psychothriller von Fitzek'),
('9783462050886', 'Der Schwarm', 2, 2004, 'Deutsch', 1024, 'Ökothriller über die Rache der Meere'),
...
(1, 1, TRUE), (2, 6, TRUE), (3, 3, TRUE), (4, 8, TRUE), (5, 7, TRUE),
(6, 2, TRUE), (7, 7, TRUE), (8, 1, TRUE), (9, 4, TRUE), (10, 8, TRUE),
(11, 11, TRUE), (12, 12, TRUE);

-- =====================================================
-- BUCH_GENRE
-- =====================================================
INSERT INTO buch_genre (buch_id, genre_id) VALUES
(1, 1), (1, 6), (2, 1), (2, 6), (3, 1), (4, 2), (4, 8), (5, 1), (5, 6),
(6, 3), (6, 9), (7, 2), (8, 1), (8, 11), (9, 1), (9, 7), (10, 2), (10, 8),
(11, 2), (11, 3), (12, 2), (12, 8);

-- =====================================================
-- STANDORT (12 Einträge)
-- =====================================================
...
(1, 'Zuhause', 'Hauptstraße 12', '10115', 'Berlin', 52.520008, 13.404954, 'Mo-Fr 18-20 Uhr', TRUE, TRUE),
(2, 'Wohnung', 'Bergstraße 45', '80331', 'München', 48.135124, 11.581981, 'Nach Vereinbarung', FALSE, TRUE),
(3, 'Haus', 'Seeufer 7', '78462', 'Konstanz', 47.677950, 9.173240, 'Sa 10-14 Uhr', FALSE, TRUE),
(4, 'Büro', 'Marktplatz 3', '50667', 'Köln', 50.937531, 6.960279, 'Mo-Fr 9-17 Uhr', TRUE, FALSE),
(5, 'Zuhause', 'Lindenweg 9', '20095', 'Hamburg', 53.551086, 9.993682, 'Di+Do 16-19 Uhr', TRUE, TRUE),
(6, 'Wohnung', 'Schulstraße 22', '60311', 'Frankfurt', 50.110924, 8.682127, 'Nach Vereinbarung', FALSE, TRUE),
(7, 'Haus', 'Gartenweg 5', '30159', 'Hannover', 52.375891, 9.732010, 'Mo-Fr 17-20 Uhr', FALSE, TRUE),
(8, 'Büro', 'Rathausplatz 1', '90402', 'Nürnberg', 49.452030, 11.076750, 'Mo-Fr 8-16 Uhr', TRUE, FALSE),
(9, 'Zuhause', 'Bahnhofstraße 15', '01067', 'Dresden', 51.050409, 13.737262, 'Sa+So 10-18 Uhr', TRUE, TRUE),
(10, 'Wohnung', 'Am See 3', '24103', 'Kiel', 54.323293, 10.122765, 'Nach Vereinbarung', FALSE, TRUE),
(11, 'Zuhause', 'Waldstraße 8', '70173', 'Stuttgart', 48.775846, 9.182932, 'Mo-Fr 17-21 Uhr', TRUE, TRUE),
(12, 'Büro', 'Mozartweg 12', '40213', 'Düsseldorf', 51.227741, 6.773456, 'Mo-Fr 8-15 Uhr', FALSE, FALSE);

-- =====================================================
-- BUCH_EXEMPLAR (12 Einträge)
-- =====================================================
...
(2, 2, 2, 'gut', 'verfügbar', 21, 'Mit einigen Notizen', '2024-01-20'),
(3, 3, 3, 'neu', 'verfügbar', 30, 'Original eingeschweißt', '2024-02-01'),
(1, 4, 4, 'akzeptabel', 'verfügbar', 14, 'Etwas abgenutzt', '2024-02-10'),
(4, 5, 5, 'sehr gut', 'ausgeliehen', 21, 'Thriller für Fans', '2024-01-25'),
(5, 6, 6, 'gut', 'verfügbar', 28, 'Klassiker', '2024-02-15'),
(6, 7, 7, 'neu', 'reserviert', 30, 'Aktueller Bestseller', '2024-03-01'),
(7, 8, 8, 'sehr gut', 'verfügbar', 21, 'Spannender Krimi', '2024-02-20'),
...
(2, 3, '2024-04-01', '2024-04-28', 'offen', 'Ich würde das Buch gerne im April lesen', '2024-03-15'),
(4, 1, '2024-03-15', '2024-03-30', 'akzeptiert', 'Darf ich es für zwei Wochen ausleihen?', '2024-03-10'),
(6, 5, '2024-04-01', '2024-04-22', 'offen', 'Ist der Fitzek noch verfügbar?', '2024-03-18'),
(8, 7, '2024-04-05', '2024-05-03', 'offen', 'Würde es gerne im April lesen', '2024-03-20'),
(10, 9, '2024-03-20', '2024-04-03', 'abgelehnt', 'Kurzfristig möglich?', '2024-03-17'),
(1, 2, '2024-04-01', '2024-04-15', 'offen', 'Ist das Buch noch da?', '2024-03-19'),
...
(9, 10, '2024-04-15', '2024-05-13', 'offen', 'Kann ich es verlängern?', '2024-03-22'),
(11, 11, '2024-04-01', '2024-04-22', 'offen', 'Würde den neuen Fitzek gerne lesen', '2024-03-25'),
(12, 12, '2024-04-05', '2024-04-19', 'akzeptiert', 'Danke für die schnelle Antwort', '2024-03-23');

-- =====================================================
-- BEWERTUNG (12 Einträge)
-- =====================================================
INSERT INTO bewertung (bewertende_id, bewertete_id, exemplar_id, ausleihe_id, sterne, kommentar, datum) VALUES
(2, 1, NULL, 1, 5, 'Sehr netter Verleiher, Buch in toller Verfassung', '2024-02-26'),
(1, 2, NULL, 1, 4, 'Pünktliche Rückgabe, alles gut', '2024-02-26'),
(3, 2, NULL, 2, 5, 'Unkomplizierte Abholung', '2024-03-08'),
(4, 3, NULL, 3, 5, 'Sehr zuverlässig', '2024-03-02'),
(5, 4, NULL, 4, 4, 'Gerne wieder', '2024-02-23'),
(NULL, NULL, 1, 1, 5, 'Tolles Buch, guter Zustand', '2024-02-26'),
(NULL, NULL, 2, 2, 4, 'Spannend, aber etwas abgenutzt', '2024-03-07'),
(NULL, NULL, 4, 4, 3, 'Akzeptabler Zustand', '2024-02-23'),
(NULL, NULL, 6, 6, 5, 'Klassiker in gutem Zustand', '2024-02-06'),
(NULL, NULL, 8, 8, 4, 'Schneller Lesestoff', '2024-03-02'),
(NULL, NULL, 11, 11, 5, 'Spannend bis zur letzten Seite', '2024-03-26'),
(3, 12, NULL, 12, 5, 'Schnelle Rückgabe, alles super', '2024-03-26');

-- =====================================================
-- NACHRICHT (12 Einträge)
-- =====================================================
INSERT INTO nachricht (sender_id, empfaenger_id, betreff, inhalt, zeitstempel, gelesen) VALUES
(2, 1, 'Frage zu "Vermessung der Welt"', 'Hallo, ist das Buch noch verfügbar?', '2024-03-01 10:30:00', TRUE),
(1, 2, 'Re: Frage zu Buch', 'Ja, können Sie gerne ausleihen!', '2024-03-01 11:15:00', TRUE),
(3, 2, 'Ausleihanfrage', 'Würde gerne "Der Vorleser" ausleihen', '2024-03-02 14:20:00', TRUE),
(2, 3, 'Bestätigung', 'Klar, wann passt es?', '2024-03-02 15:00:00', TRUE),
(4, 3, 'Danke!', 'Buch ist angekommen, vielen Dank!', '2024-03-05 18:30:00', FALSE),
(5, 4, 'Rückgabe', 'Habe das Buch heute zurückgebracht', '2024-02-22 16:45:00', TRUE),
(6, 5, 'Verlängerung möglich?', 'Kann ich das Buch noch eine Woche behalten?', '2024-03-15 09:10:00', FALSE),
(7, 6, 'Erinnerung', 'Bitte bald zurückgeben', '2024-02-28 20:00:00', TRUE),
(8, 7, 'Neues Buch eingestellt', 'Habe einen neuen Fitzek eingestellt', '2024-03-10 12:00:00', FALSE),
(9, 8, 'Treffen', 'Können uns am Samstag treffen', '2024-02-25 08:30:00', TRUE),
(10, 9, 'Frage zum Zustand', 'Ist das Buch noch in gutem Zustand?', '2024-03-20 14:15:00', TRUE),
(11, 10, 'Abholung', 'Kann es morgen Abend abholen', '2024-03-22 19:30:00', FALSE);

-- BUCH_SUCHE (12 Einträge)
